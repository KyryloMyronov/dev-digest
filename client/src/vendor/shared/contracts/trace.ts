...
export const PromptAssembly = z.object({
  ...
  /** Derived PR intent block (L03); null when derivation was skipped or failed. */
...
export const RunStats = z.object({
  ...
  /** USD cost of the run; null when the model isn't in the price table. */
...
export const RunSummary = z.object({
  ...
  /** USD cost of the run; null on unpriced models and on unsettled runs. */
  cost_usd: z.number().nullable(),
